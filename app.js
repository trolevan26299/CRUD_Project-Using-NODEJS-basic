...
//connect to mongoDB
const CONNECTION_URL = `mongodb+srv://${databaseConfig.username}:${databaseConfig.password}@cluster0.sghp3.mongodb.net/myFirstDatabase?retryWrites=true&w=majority`;
const connector = mongoose.connect(CONNECTION_URL, { dbName: databaseConfig.database });
